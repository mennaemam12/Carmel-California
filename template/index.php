  ...
  <div class="container-scroller">
    ...
    <nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
      <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center" style="background-color: #DFE0DA;">
        <a class="navbar-brand brand-logo mr-5" href="index.html"><img src="images/CARMEL (2).png" class="mr-2" alt="logo"/></a>
    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar" style="background-color: #DFE0DA;">
        <ul class="nav">
          <li class="nav-item">
            <a class="nav-link" href="index.html" aria-expanded="false" aria-controls="ui-basic">
      ...
      <div class="main-panel">
        <div class="content-wrapper" style="background-color: #DFE0DA;">
          ...
          <div class="row">
            <div class="col-md-6 grid-margin stretch-card">
              <div class="card tale-bg" style="height:400px;width:300px;overflow: hidden;">
                <div class="card-people mt-auto">
                  <img src="images/dashboard/test.jpg" alt="people">
             =
                </div>
              </div>
            </div>
            <div class="col-md-6 grid-margin transparent">
              <div class="row">
                <div class="col-md-6 mb-4 stretch-card transparent">
                  <div class="card card-tale" style="background-color: #4F7302;">
                    <div class="card-body">
                      <p class="mb-4">Pending Orders</p>
                      <p class="fs-30 mb-2">237</p>
                      <p>10.00% (30 days)</p>
                    </div>
                  </div>
                </div>
                <div class="col-md-6 mb-4 stretch-card transparent" >
                  <div class="card card-dark-blue" style="background-color: #F2B33D;">
                    <div class="card-body">
                      <p class="mb-4">Active Orders</p>
                      <p class="fs-30 mb-2">164</p>
                      <p>22.00% (30 days)</p>
                    </div>
                  </div>
                </div>
              ...
              <div class="row">
                <div class="col-md-6 mb-4 mb-lg-0 stretch-card transparent">
                  <div class="card card-light-blue" style="background-color: #A65A53;">
                    <div class="card-body">
                ...
                <div class="col-md-6 stretch-card transparent">
                  <div class="card card-light-danger" style="background-color: #807A7C;">
                    <div class="card-body">
                      <p class="mb-4">Food Items</p>
                      <p class="fs-30 mb-2">455</p>
                      <p>0.22% (30 days)</p>
                    </div>
                  </div>
                </div>
            ...
            <div class="col-md-6 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  ...
                  <p class="font-weight-500">The cumulative restaurant revenue during the selected timeframe. It's the total income generated from customers dining in your establishment within a specific period.</p>
              ...
              <div class="card">
                <div class="card-body">
                 <div class="d-flex justify-content-between">
                  ...
                  <p class="font-weight-500">The comprehensive restaurant orders report within the chosen timeframe. It summarizes the total order activity on your platform over a specific period.</p>
                              ...
                              <div class="col-md-6 border-right">
                                <div class="table-responsive mb-3 mb-md-0 mt-3">
                                  <table class="table table-borderless report-table">
                                    ...
                                    <tr>
                                      <td class="text-muted">Zamalek</td>
                                      <td class="w-100 px-0">
                                        <div class="progress progress-md mx-4">
                                    ...
                                    <tr>
                                      <td class="text-muted">Nasr City</td>
                                      <td class="w-100 px-0">
                                        <div class="progress progress-md mx-4">
                                    ...
                                    <tr>
                                      <td class="text-muted">Madinaty</td>
                                      <td class="w-100 px-0">
                                        <div class="progress progress-md mx-4">
                                    ...
                                    <tr>
                                      <td class="text-muted">El Rehab</td>
                                      <td class="w-100 px-0">
                                        <div class="progress progress-md mx-4">
                      ...
                      <div class="carousel-item">
                        <div class="row">
                          <div class="col-md-12 col-xl-3 d-flex flex-column justify-content-start">
                            ...
                            <p class="card-title">Detailed Reports</p>
                              <h1 class="text-primary">$34040</h1>
                              <h3 class="font-weight-500 mb-xl-4 text-primary">Alexandria</h3>
                              <p class="mb-2 mb-xl-0">The total number of sessions within the date range. It is the period time a user is actively engaged with your website, page or app, etc</p>
                            </div>  
                            </div>
                          <div class="col-md-12 col-xl-9">
                  ...
                  <div class="table-responsive">
                    <table class="table table-striped table-borderless">
                      ...
                      <tbody>
                        ...
                        <tr>
                          <td>Fried Chicken Pesto Sando</td>
          ...
          <div class="row">
            <div class="col-md-4 stretch-card grid-margin">
              <div class="card">
                <div class="card-body">
                  <p class="card-title mb-0">Branches</p>
                  <div class="table-responsive">
                    <table class="table table-borderless">
                      ...
                      <tbody>
                        <tr>
                          <td class="pl-0">Tagamoaa</td>
                          <td><p class="mb-0"><span class="font-weight-bold mr-2">65</span>(2.15%)</p></td>
                          <td class="text-muted">65</td>
                        </tr>
                        <tr>
                          <td class="pl-0">Maadi</td>
                          <td><p class="mb-0"><span class="font-weight-bold mr-2">54</span>(3.25%)</p></td>
                          <td class="text-muted">51</td>
                        </tr>
                        <tr>
                          <td class="pl-0">Rehab</td>
                          <td><p class="mb-0"><span class="font-weight-bold mr-2">22</span>(2.22%)</p></td>
                          <td class="text-muted">32</td>
                        </tr>
                        <tr>
                          <td class="pl-0">Zamalek</td>
                          <td><p class="mb-0"><span class="font-weight-bold mr-2">46</span>(3.27%)</p></td>
                          <td class="text-muted">15</td>
                        </tr>
                        <tr>
                          <td class="pl-0">Madinaty</td>
                          <td><p class="mb-0"><span class="font-weight-bold mr-2">17</span>(1.25%)</p></td>
                          <td class="text-muted">25</td>
                        </tr>
                        <tr>
                          <td class="pl-0">Nasr City</td>
                          <td><p class="mb-0"><span class="font-weight-bold mr-2">52</span>(3.11%)</p></td>
                          <td class="text-muted">71</td>
                        </tr>
                        <tr>
                          <td class="pl-0 pb-0">Shorouk</td>
        ...
        <footer class="footer" style="background-color: #DFE0DA;">
          <div class="d-sm-flex justify-content-center justify-content-sm-between" >
            <span class="text-muted text-center text-sm-left d-block d-sm-inline-block">Copyright © 2021.  Carmel Calfornia. All rights reserved.</span>
