                ...
                <div class="card-body">
                  ...
                  <form class="forms-sample">
                    ...
                    <div class="form-group">
                      ...
                      <input type="email" class="form-control" id="exampleInputEmail3" placeholder="Product Price">
                    </div>
                    <div class="form-group">
                      <label for="exampleInputPassword4">Product Ingredients</label>
                      <input type="password" class="form-control" id="exampleInputPassword4" placeholder="Product Ingredients">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      <label for="exampleTextarea1">Specifications</label>
