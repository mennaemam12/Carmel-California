    ...
    <ul class="nav">
        ...
        <li class="nav-item" id="sidebar-menu">
            ...
            <div class="collapse" id="ui-basic">
                <ul class="nav flex-column sub-menu">
                    ...
                    <li class="nav-item"><a class="nav-link" href="dashboard/menu?action=addoption">Add Option</a></li>
                    <li class="nav-item"><a class="nav-link" href="dashboard/menu?action=addingredient">Add Ingredient</a></li>
                </ul>
            </div>
        </li>

        <li class="nav-item" id="sidebar-reports">
        ...
        <li class="nav-item" id="sidebar-orders">
            ...
            <div class="collapse" id="tables">
                <ul class="nav flex-column sub-menu">
                    <li class="nav-item"><a class="nav-link" href="dashboard/orders">Order Tracks</a></li>
                </ul>
            </div>
        </li>
        <!--    <li class="nav-item" id = "sidebar-drivers">-->
        ...
        <!--    <li class="nav-item" id = "sidebar-authorization">-->
        ...
        <li class="nav-item" id="sidebar-users">
            ...
            <div class="collapse" id="users">
                <ul class="nav flex-column sub-menu">
                    ...
                    <li class="nav-item"><a class="nav-link" href="dashboard/users?action=viewusertypes"> User
                            Types </a></li>
                </ul>
            </div>
        </li>
        <!--    <li class="nav-item" id = "sidebar-points">-->
        ...
        <li class="nav-item" id="sidebar-reviews">
