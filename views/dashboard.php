  ...
  <div class="container-scroller">
    ...
    <nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
      <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center" style="background-color: #DFE0DA;">
        <a class="navbar-brand brand-logo mr-5" href="index"><img src="template/images/CARMEL (2).png" class="mr-2" alt="logo" /></a>
        <a class="navbar-brand brand-logo-mini" href="index"><img src="template/images/logo-mini.svg" alt="logo" /></a>
      </div>
