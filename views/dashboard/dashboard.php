                    ...
                    <div class="col-md-6 grid-margin stretch-card">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <p class="font-weight-500">The cumulative restaurant revenue during the selected
                                    timeframe. It's the total income generated from customers dining in your
                                    establishment within a specific period.</p>
                    ...
                    <div class="col-md-6 grid-margin stretch-card">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <p class="font-weight-500">The comprehensive restaurant orders report within the chosen
                                    timeframe. It summarizes the total order activity on your platform over a specific
                                    period.</p>
