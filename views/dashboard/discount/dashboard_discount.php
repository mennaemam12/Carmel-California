                        ...
                        <div class="card">
                            <div class="viewItemsContainer">
                                ...
                                <table>
                                    ...
                                    <?php
                                    if (!$rows) {
                                        echo "<tr><td colspan='7' style='text-align: center'>No discounts found</td></tr>";
                                    }
                                    else {
                                        for ($i = 0; $i < count($rows); $i++) {
                                            ...
                                            echo "<td>
                                                    <a class='itemOptions' href='dashboard/discount?action=edit&id=" . $rows[$i]->id . "'>
