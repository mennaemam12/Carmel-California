            ...
            <div class="row slider-text justify-content-center align-items-center" data-scrollax-parent="true">
                ...
                <div style=" z-index: 0; padding:30px; border-radius: 10px;	text-align: center;">
                    <div style="z-index:0;">
                        ...
                        <p><a href="#" class="btn btn-secondary btn-outline-white p-3 px-xl-4 py-xl-3">Order Now</a> <a
                                    href="menu" class="btn btn-secondary btn-outline-white p-3 px-xl-4 py-xl-3">View
                                Menu</a></p>
                    </div>
                </div>
                ...
                <div style="z-index: 0; padding:30px; border-radius: 10px;	text-align: center;">
                    <div style="z-index:0;">
                        ...
                        <p><a href="#" class="btn btn-secondary p-3 px-xl-4 py-xl-3">Order Now</a> <a href="menu"
                                                                                                      class="btn btn-secondary btn-outline-white p-3 px-xl-4 py-xl-3">View
                                Menu</a></p>
                    </div>
                </div>
...
<section class="ftco-section img" id="ftco-testimony"
         style="background-image: url(public/images/cover2.jpg);background-size: cover;"
