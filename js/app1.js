...
submitBtn = document.querySelector('.submitBtn'),
 ...
 formInputFields = document.querySelectorAll('form input'),
  ...
  orderNumbers = document.getElementById("orderNumbers"),
...
let originalData = localStorage.getItem('customerProfile') ? JSON.parse(localStorage.getItem('customerProfile')) : []
    ...
    if(getData.length > 0){
        for(var i=tab_start; i<tab_end; i++){
            ...
            if(staff){
                ...
                <td>${staff.ageVal}</td>
                <td>${staff.cityVal}</td>
                <td>${staff.orderNumbersVal}</td>
                <td>${staff.pointsVal}</td>
                <td>${staff.birthdayVal}</td>
                <td>${staff.emailVal}</td>
                <td>${staff.phoneVal}</td>
                <td>
                    <button onclick="readInfo('${staff.picture}', '${staff.fName}', '${staff.lName}', '${staff.ageVal}', '${staff.cityVal}', '${staff.orderNumbersVal}', '${staff.pointsVal}', '${staff.birthdayVal}', '${staff.emailVal}', '${staff.phoneVal}')"><i class="fa-regular fa-eye"></i></button>

                    <button onclick="editInfo('${i}', '${staff.picture}', '${staff.fName}', '${staff.lName}', '${staff.ageVal}', '${staff.cityVal}', '${staff.orderNumbersVal}', '${staff.pointsVal}', '${staff.birthdayVal}', '${staff.emailVal}', '${staff.phoneVal}')"><i class="fa-regular fa-pen-to-square"></i></button>
        ...
        customerInfo.innerHTML = `<tr class="customerDetails"><td class="empty" colspan="11" align="center">No data available in table</td></tr>`
        table.style.minWidth = "1280px"
    }
}
...
function readInfo(pic, fname, lname, Age, City, OrderNumbers, Points, Birthday, Email, Phone){
    imgInput.src = pic
    fName.value = fname
    lName.value = lname
    age.value = Age
...
function editInfo(id, pic, fname, lname, Age, City, OrderNumbers, Points, Birthday, Email, Phone){
    isEdit = true
    editId = id
...
function deleteInfo(index){
    if(confirm("Aer you sure want to delete?")){
        ...
        localStorage.setItem("customerProfile", JSON.stringify(originalData));
...
filterData.addEventListener("input", ()=> {
    ...
    if(searchTerm !== ""){
        ...
        getData = JSON.parse(localStorage.getItem('customerProfile')) || []
    }
